        ...
        body: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                customInputWidget(nameController, "Experiance title", const Icon(Icons.person_outline_sharp)),
                customInputWidget(cityController, "City", const Icon(Icons.location_city)),
                // The dates is simple text input at the moment ,might upgrade to a datepicker in the futer.
                customInputWidget(startDateController, "Start Date", const Icon(Icons.date_range)),
                customInputWidget(endDateController, "End Date", const Icon(Icons.date_range)),
                customInputWidget(companyController, "Company", const Icon(Icons.house)),
                customInputWidget(descriptionController, "Description", const Icon(Icons.description)),
